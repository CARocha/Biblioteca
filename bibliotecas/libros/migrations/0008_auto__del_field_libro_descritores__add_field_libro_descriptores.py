...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Libro.descritores'
        db.delete_column('libros_libro', 'descritores')

        # Adding field 'Libro.descriptores'
        db.add_column('libros_libro', 'descriptores', self.gf('bibliotecas.tagging_autocomplete.models.TagAutocompleteField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Libro.descritores'
        db.add_column('libros_libro', 'descritores', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'Libro.descriptores'
        db.delete_column('libros_libro', 'descriptores')
