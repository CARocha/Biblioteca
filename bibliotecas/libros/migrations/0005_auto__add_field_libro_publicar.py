...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Libro.publicar'
        db.add_column('libros_libro', 'publicar', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Libro.publicar'
        db.delete_column('libros_libro', 'publicar')
