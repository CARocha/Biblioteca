...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TipoDocumento.logo'
        db.add_column('libros_tipodocumento', 'logo', self.gf('bibliotecas.libros.thumbs.ImageWithThumbsField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TipoDocumento.logo'
        db.delete_column('libros_tipodocumento', 'logo')
