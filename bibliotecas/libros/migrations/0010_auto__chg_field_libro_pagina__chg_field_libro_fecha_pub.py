...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Libro.pagina'
        db.alter_column('libros_libro', 'pagina', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Libro.fecha_pub'
        db.alter_column('libros_libro', 'fecha_pub', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Libro.pagina'
        db.alter_column('libros_libro', 'pagina', self.gf('django.db.models.fields.IntegerField')(null=True))
