...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Libro.No_acceso'
        db.add_column('libros_libro', 'No_acceso', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Libro.No_acceso'
        db.delete_column('libros_libro', 'No_acceso')
